...
export class PumpAmmInternalSdk {
  ...
  async buyBaseInput(
    ...
    const { maxQuote } = this.buyBaseInputInternal(
      swapSolanaState,
      base,
      slippage,
    );
  ...
  async buyQuoteInput(
    ...
    const { base, maxQuote } = this.buyQuoteInputInternal(
      swapSolanaState,
      quote,
      slippage,
    );
  ...
  buyAutocompleteQuoteFromBase(
    swapSolanaState: SwapSolanaState,
    base: BN,
    slippage: number,
  ): BN {
    const { uiQuote } = this.buyBaseInputInternal(
      swapSolanaState,
      base,
      slippage,
    );
  ...
  buyAutocompleteBaseFromQuote(
    swapSolanaState: SwapSolanaState,
    quote: BN,
    slippage: number,
  ): BN {
    const { base } = this.buyQuoteInputInternal(
      swapSolanaState,
      quote,
      slippage,
    );
  ...
  async sellBaseInput(
    ...
    const { minQuote } = this.sellBaseInputInternal(
      swapSolanaState,
      base,
      slippage,
    );
  ...
  async sellQuoteInput(
    ...
    const { base, minQuote } = this.sellQuoteInputInternal(
      swapSolanaState,
      quote,
      slippage,
    );
  ...
  sellAutocompleteQuoteFromBase(
    swapSolanaState: SwapSolanaState,
    base: BN,
    slippage: number,
  ): BN {
    const { uiQuote } = this.sellBaseInputInternal(
      swapSolanaState,
      base,
      slippage,
    );
  ...
  sellAutocompleteBaseFromQuote(
    swapSolanaState: SwapSolanaState,
    quote: BN,
    slippage: number,
  ): BN {
    const { base } = this.sellQuoteInputInternal(
      swapSolanaState,
      quote,
      slippage,
    );
